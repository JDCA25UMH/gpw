...
--------------------------------------------
 ...
 function Disparo.new(x,y, velocidad_x,
 velocidad_y,direccion)
  local instance = setmetatable({},
  Disparo)
  instance.x = x
  instance.y = y
  instance.velocidad_x = velocidad_x
  instance.velocidad_y = velocidad_y
...
function n_bala()  
 ...
 os.time()
 shot_x = math.random(sw/12+12,sw-12)

 shot_x_min, shot_x_max =shot_x<sw/2,
 shot_x> sw/2
 
 condicion=(shot_x< sw/2)
  and shot_x_min or 
  shot_x_max
...
shot = Disparo.new(mini, sh-20,1,
-1.5,1)
 nuevaBala = {
 
 x= mini,
 y=shot.y,
 velocidad_x = shot.velocidad_x,
 velocidad_y = shot.velocidad_y,
 direccion = shot.direccion
 }

 table.insert(balas,nuevaBala)
elseif shot_x_max then 

local maxi=shot_x

shot02 = Disparo.new(maxi,sh-20,1,
-1.5,1)
nuevaBala02 = {

x= maxi, 
y= shot02.y,
velocidad_x= shot02.velocidad_x,
velocidad_y = shot02.velocidad_y,
direccion = shot02.direccion 
}
...
for i=#balas02,1,-1 do
for i=#balas02,1,-1 do
if shot_x_max then
 balas02[i].x = balas02[i].x-
 balas02[i].velocidad_x
 
 balas02[i].y = balas02[i].y+
 balas02[i].velocidad_y
end
end
break
end
...
----------------------------------------------------------------
function buton_restart(buton_color,
...
---------------------------------------------------------
 ...
 buton_restart({r=buttons.colors["red"],
...
function _update()
for i=#balas,1,-1 do
 if balas[i].y <= sh/2-20 then
  balas[i].velocidad_x = 0
  balas[i].velocidad_y=0 

 end
end

for i=#balas02,1,-1 do
 if balas02[i].y<=sh/2-20 then
 balas02[i].velocidad_x= 0
 balas02[i].velocidad_y=0
 end
end
end
...
elseif game.state["running"]then
  ...
  for i, bala02 in ipairs(balas02)do
   Sprite(1,bala02.x, bala02.y)
  end
end
...

